...
# Inputs
num_vms = st.slider("Number of VMs", 1, 50, 10) if mode == "Auto-generate" else st.number_input("Enter number of VMs", min_value=1, step=1)
num_pms = st.slider("Number of PMs", 1, 20, 5) if mode == "Auto-generate" else st.number_input("Enter number of PMs", min_value=1, step=1)
